        ...
        >
            ...
            >
                <Stack gap={1} mt={2}>
                    ...
                    <Typography>
                        <MathJax>{"\\( P_{0} = P \\)"}</MathJax>
                    </Typography>
                    <Typography>
                        <MathJax>{"\\( v_{0} = V_{rms} \\)"}</MathJax>
                    </Typography>
                    <Typography>
                        <MathJax>{"\\( P_{1} = 2P \\)"}</MathJax>
                    </Typography>
                </Stack>
                <Stack>
                    <Typography fontWeight={600} fontSize={"1.2em"}>
                    ...
                    <Typography>
                        <MathJax>{"\\[ v \\propto \\sqrt{P} \\]"}</MathJax>
                    </Typography>
                </Stack>
                <Stack>
                    <Typography fontWeight={600} fontSize={"1.2em"}>
        ...
        >
            ...
            >
                <Stack gap={1} mt={2}>
                    ...
                    <Typography>
                        <MathJax>{"\\( V = 2,4 \\space m^{3} \\)"}</MathJax>
                    </Typography>
                    <Typography>
                        <MathJax>{"\\( m = 2 \\space kg \\)"}</MathJax>
                    </Typography>
                    <Typography>
                        <MathJax>{"\\( P = 1,3 \\space atm \\)"}</MathJax>
                    </Typography>
                </Stack>
                <Stack>
                    <Typography fontWeight={600} fontSize={"1.2em"}>
        ...
        >
            ...
            >
                <Stack gap={1} mt={2}>
                    ...
                    <Typography>
                        <MathJax>{"\\( P_{b} = 0,5 \\space atm \\)"}</MathJax>
                    </Typography>
                    <Typography>
                        <MathJax>{"\\( V_{p} = 50 \\space cm^{3} \\)"}</MathJax>
                    </Typography>
                    <Typography>
                        <MathJax>
                            {
        ...
        >
                ...
                equation={
                    <>
                        <Typography fontSize={"1em"}>
                            Menurut teori kinetik gas, tekanan gas dalam ruang
                            tertutup:
                        </Typography>
            ...
            >
                <Stack gap={3}>
                    <Stack>
                        <Typography>
                            <MathJax>{"\\[E_{k}=\\frac{3}{2}PV\\]"}</MathJax>
                        </Typography>
        ...
        >
            ...
            >
                <Stack gap={1} mt={2}>
                    ...
                    <Typography>
                        <MathJax>{"\\( T=300 \\space K \\)"}</MathJax>
                    </Typography>
                    <Typography>
                        <MathJax>{"\\( E_{k1} = 2E_{k0} \\)"}</MathJax>
                    </Typography>
                </Stack>
                <Stack>
                    <Typography fontWeight={600} fontSize={"1.2em"}>
        ...
        >
            ...
            >
                <Stack gap={1} mt={2}>
                    ...
                    <Typography>
                        <MathJax>{"\\( m_{N} = 14m_{H}\\)"}</MathJax>
                    </Typography>
                    <Typography>
                        <MathJax>{"\\( T_{N} = 294 \\space K \\)"}</MathJax>
                    </Typography>
                    <Typography>
                        <MathJax>{"\\( v_{N} = v_{H} \\)"}</MathJax>
                    </Typography>
                </Stack>
                <Stack>
                    <Typography fontWeight={600} fontSize={"1.2em"}>
        ...
        >
            ...
            >
                <Stack gap={1} mt={2}>
                    ...
                    <Typography>
                        <MathJax>{"\\( T = 27^{\\circ}C \\)"}</MathJax>
                    </Typography>
                    <Typography>
                        <MathJax>{"\\( P_{1} = 5 \\space atm \\)"}</MathJax>
                    </Typography>
                    <Typography>
                        <MathJax>{"\\( V_{1} = 5 \\space L \\)"}</MathJax>
                    </Typography>
                    <Typography>
                        <MathJax>{"\\( P_{2} = 4 \\space atm \\)"}</MathJax>
                    </Typography>
                </Stack>
                <Stack>
                    <Typography fontWeight={600} fontSize={"1.2em"}>
                    ...
                    <Typography>
                        <MathJax>{"\\[ P_{1}V_{1}=P_{2}V_{2} \\]"}</MathJax>
                    </Typography>
                </Stack>
                <Stack>
                    <Typography fontWeight={600} fontSize={"1.2em"}>
        ...
        >
            ...
            >
                <Stack gap={1} mt={2}>
                    ...
                    <Typography>
                        <MathJax>{"\\( P = 165,6 \\space Pa \\)"}</MathJax>
                    </Typography>
                </Stack>
                <Stack>
                    <Typography fontWeight={600} fontSize={"1.2em"}>
        ...
        >
            ...
            >
                ...
                <Stack>
                    ...
                    <Typography>
                        <MathJax>{"\\[ \\sum E = N \\cdot E_{k} \\]"}</MathJax>
                    </Typography>
                </Stack>
                <Stack>
                    <Typography fontWeight={600} fontSize={"1.2em"}>
        ...
        >
            ...
            >
                <Stack gap={1} mt={2}>
                    ...
                    <Typography>
                        <MathJax>{"\\( T_{A}=T_{B} \\)"}</MathJax>
                    </Typography>
                    <Typography>
                        <MathJax>{"\\( m_{A} =M_{A} \\)"}</MathJax>
                    </Typography>
                    <Typography>
                        <MathJax>{"\\( m_{B} =M_{B} \\)"}</MathJax>
                    </Typography>
                    <Typography>
                        <MathJax>{"\\( p_{A} =P_{A} \\)"}</MathJax>
                    </Typography>
                    <Typography>
                        <MathJax>{"\\( p_{B} =P_{B} \\)"}</MathJax>
                    </Typography>
                </Stack>
                <Stack>
                    <Typography fontWeight={600} fontSize={"1.2em"}>
                    ...
                    <Stack gap={3}>
                        <Stack>
                            <Typography>
                                ...
                                antar molekul, karena tidak ada gaya
                                tarik-menarik. Energinya murni{" "}
                                <Typography
                                    component={"span"}
                                    className="highlight"
                                >
